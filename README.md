...
performed and the retrieved value is inserted in the cache before being returned to the client. Each cache entry 
is being invalidated after one hour. After a cached value is expired, **Meteo** must retrieve it directly 
